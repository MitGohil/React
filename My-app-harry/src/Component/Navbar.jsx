        ...
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="me-auto mb-2 mb-lg-0 form-check form-switch">
...
//Prototype use for condition.We set title and aboutText props are string.
// If user enter number than give error.only string valid
// isRequired : If user not pass props than give error
Navbar.prototype = {
